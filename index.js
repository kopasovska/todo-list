import{a as D,f as E}from"./assets/vendor-i2X6OA9E.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const l of n.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function a(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(r){if(r.ep)return;r.ep=!0;const n=a(r);fetch(r.href,n)}})();const i={listInput:document.querySelector(".list-input"),addListForm:document.querySelector(".add-new-list-form"),statsContainer:document.querySelector(".nav-stats"),cardsContainer:document.querySelector(".cards-list"),noCardsInfo:document.querySelector(".no-lists-info"),themeToggleBtn:document.querySelector(".theme-toggle-btn"),root:document.documentElement,weatherWidget:document.querySelector(".weather-widget")},d=()=>JSON.parse(localStorage.getItem("todoApp"))||[],p=t=>{localStorage.setItem("todoApp",JSON.stringify(t))},_=()=>{const t=d();if(!t.length)i.statsContainer.textContent="0/0 tasks completed";else{const e=t.reduce((s,r)=>s+r.tasks.length,0),a=t.reduce((s,r)=>s+r.tasks.filter(n=>n.completed).length,0);i.statsContainer.textContent=`${a||"0"}/${e} tasks completed`}},A=t=>`
