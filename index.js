import{a as E,f as W}from"./assets/vendor-i2X6OA9E.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function s(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=s(n);fetch(n.href,i)}})();const r={listInput:document.querySelector(".list-input"),addListForm:document.querySelector(".add-new-list-form"),statsContainer:document.querySelector(".nav-stats"),cardsContainer:document.querySelector(".cards-list"),noCardsInfo:document.querySelector(".no-lists-info"),themeToggleBtn:document.querySelector(".theme-toggle-btn"),root:document.documentElement,weatherButton:document.querySelector(".weather-button"),faSunIcon:document.querySelector(".fa-sun"),faCloudIcon:document.querySelector(".fa-cloud"),weatherWidget:document.querySelector(".weather-widget")},d=()=>JSON.parse(localStorage.getItem("todoApp"))||[],m=t=>{localStorage.setItem("todoApp",JSON.stringify(t))},$=()=>{const t=d();if(!t.length)r.statsContainer.textContent="0/0 tasks completed";else{const e=t.reduce((a,n)=>a+n.tasks.length,0),s=t.reduce((a,n)=>a+n.tasks.filter(i=>i.completed).length,0);r.statsContainer.textContent=`${s||"0"}/${e} tasks completed`}},q=t=>`
  ...
  <p>Try again later!</p>`,z=t=>{r.weatherWidget.innerHTML="",r.weatherWidget.innerHTML=K(t)};r.addListForm.addEventListener("submit",t=>{t.preventDefault();const e=r.listInput.value.trim();e&&(M(e),r.listInput.value="")});r.cardsContainer.addEventListener("click",t=>{if(t.target.closest(".delete-card-btn")){const s=t.target.closest(".cards-item").dataset.id;N(s)}});r.cardsContainer.addEventListener("submit",t=>{const e=t.target.closest(".add-new-task-form");if(e){t.preventDefault();const s=e.querySelector(".task-input"),a=s.value.trim();if(!a)return;const i=e.closest(".cards-item").dataset.id;O(i,a),s.value=""}});r.cardsContainer.addEventListener("click",t=>{if(t.target.closest(".delete-task-btn")){const e=t.target.closest(".task-item"),s=e.dataset.id;if(!s)return;const n=e.closest(".cards-item").dataset.id;B(n,s)}});r.cardsContainer.addEventListener("click",t=>{if(t.target.closest(".task-check")){const e=t.target.closest(".task-item"),s=e.dataset.id;if(!s)return;const n=e.closest(".cards-item").dataset.id;F(n,s)}});r.cardsContainer.addEventListener("click",t=>{if(t.target.closest(".reset-all-tasks-btn")){const s=t.target.closest(".cards-item").dataset.id;H(s)}});r.cardsContainer.addEventListener("click",t=>{if(t.target.closest(".edit-task-btn")){const e=t.target.closest(".task-item"),s=e.querySelector(".task-text"),a=document.createElement("input");a.type="text",a.className="text-input task-input",a.value=s.textContent,s.replaceWith(a),a.focus();const n=e.querySelector(".task-toolbar");n.innerHTML=`<button type="button" class="secondary-btn save-task-btn">
          <i class="fa-solid fa-check"></i>
        </button>
        <button type="button" class="secondary-btn cancel-edit-btn">
          <i class="fa-solid fa-xmark"></i>
        </button>`,e.classList.add("editing")}});const C=(t,e)=>{const a=t.closest(".cards-item").dataset.id,n=t.dataset.id;P(a,n,e)};r.cardsContainer.addEventListener("click",t=>{if(t.target.closest(".save-task-btn")){const e=t.target.closest(".task-item"),s=e.querySelector(".task-input").value.trim();if(!s)return;C(e,s)}});r.cardsContainer.addEventListener("keydown",t=>{if(t.key==="Enter"&&t.target.classList.contains("task-input")){const e=t.target.closest(".task-item"),s=e.querySelector(".task-input").value.trim();if(!s)return;C(e,s)}});r.cardsContainer.addEventListener("click",t=>{t.target.closest(".cancel-edit-btn")&&c()});r.cardsContainer.addEventListener("keydown",t=>{if(t.key==="Escape"&&t.target.classList.contains("task-input")){if(!t.target.closest(".task-item"))return;c()}});r.themeToggleBtn.addEventListener("click",()=>{r.root.classList.toggle("dark"),r.root.classList.contains("dark")?localStorage.setItem("theme","dark"):localStorage.setItem("theme","light")});r.weatherButton.addEventListener("click",()=>{r.weatherWidget.classList.contains("opened")?(r.weatherWidget.classList.remove("opened"),r.faSunIcon.classList.remove("hidden"),r.faCloudIcon.classList.remove("opened")):(r.weatherWidget.classList.add("opened"),r.faSunIcon.classList.add("hidden"),r.faCloudIcon.classList.add("opened"))});const Q=async()=>{$(),L(),J(),c();const t=await L();z(t)};Q();
